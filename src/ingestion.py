...
# --- CONFIGURATION ---
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) # Remonte d'un cran au dossier parent de 'src'
LOCAL_TSF_PATH = os.path.join(BASE_DIR, "tourism_yearly_dataset", "tourism_yearly_dataset.tsf")
...
def ingest_ticketmaster_data(s3_client):
    ...
    for page in range(6):
        ...
        try:
            ...
            print(f"Fin de pagination ou restriction de profondeur atteinte à la page {page}.")
            break
